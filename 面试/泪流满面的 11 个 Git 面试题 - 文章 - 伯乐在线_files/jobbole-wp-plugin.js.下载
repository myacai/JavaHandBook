...
jQuery(document).ready(function ($) {
    ...
    $("#date-submit-btn").bind("click", function () {
        ...
        var title = $('#submit_form_title').val();
        var profile = $('#submit_form_profile').val();
        var city = $('#submit_form_city').val();
        var details = $('#submit_form_details').val();

        submit_date($(this),"submit_date", title, profile, city, details);
    });
...
function submit_date(btn, action_name, title, profile, city, details){
